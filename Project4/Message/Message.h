...
*  --------------------
*  ver 1.3 : 14 Oct 2018
*  - converted to use new StringUtilities
*  ver 1.2 : 27 Mar 2018
...
namespace MsgPassingCommunication
{
	...
	{
		return address + ":" + Utilities::Converter_<size_t>::toString(port);
	}
	...
	inline EndPoint EndPoint::fromString(const std::string& str)
	{
		...
		ep.port = Utilities::Converter_<size_t>::toValue(portStr);
		return ep;
	}
	///////////////////////////////////////////////////////////////////
	// Message class
	...
	public:
		...
		void contentLength(std::streamsize ln);
		void clear();
		std::string toString();
